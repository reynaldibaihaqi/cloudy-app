      ...
      <div class="navbar-header" data-logobg="skin6">
        ...
        <a class="navbar-brand" href="/">
          ...
          <b class="logo-icon">
            ...
            <!-- Dark Logo icon -->
            <img src="{{ asset('/assets/images/logo-cloudy.png') }}" alt="homepage" class="dark-logo" width="35" />
            <!-- Light Logo icon -->
          ...
          <span class="logo-text ">
            <!-- dark Logo text -->
            <img src="{{ asset('/assets/images/text-cloudy.png') }}" alt="homepage" class="dark-logo" width="100" />
            <!-- Light Logo text -->
